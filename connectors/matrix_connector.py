...
class MatrixConnector(Connector):
    ...
    def __init__(self, homeserver: str, room_id: str, user_id: str = None, 
    ...
    def initialize(self) -> bool:
        ...
        try:
            if not self.homeserver or not self.room_id:
                logger.error("Missing required Matrix credentials (homeserver or room_id)")
                return False
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            url = f"{self.homeserver}/_matrix/client/r0/rooms/{quote(self.room_id)}/state"
            headers = {
                "Authorization": f"Bearer {self.access_token}",
            }
