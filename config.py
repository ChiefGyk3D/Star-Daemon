    ...
    def load_secrets(self) -> bool:
        ...
        try:
            ...
            if hasattr(response, 'secrets') and response.secrets:
                ...
                logger.info(f"Loaded {len(self.secrets_cache)} secrets from Doppler (project={project}, config={config_name})")
                return True
            else:
            ...
            logger.error("doppler-sdk not installed. Install with: pip install doppler-sdk")
            return False
...
class Config:
    ...
    def __init__(self):
        ...
        self.discord_role_id = self._get_env('DISCORD_ROLE_ID', '')  # Optional role mention
